...
if(mysqli_num_rows($res1)>0)
{
    ...
    $_SESSION['message']="<p class='red-text'>Account already exists, login to continue</p>";// popup
}
else{
...
if($res)
{
    ...
    $_SESSION['message']="<p class='green-text'>Signup Succesful, login to continue</p>";// popup
}
else
{
